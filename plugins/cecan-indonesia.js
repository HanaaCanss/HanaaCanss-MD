...
let handler = async (m, { conn }) => {
	let url = cecanindonesia[Math.floor(Math.random() * cecanindonesia.length)]
	conn.sendButtonImg(m.chat, url, 'NihhKakk✨', wm2, 'Next', '.cecanindonesia', m)
}
handler.help = ['cecanindonesia']
handler.tags = ['cecan']
handler.command = /^(cecanindonesia)$/i

module.exports = handler

global.cecanindonesia = [
